<div class="sidebar-menu">
	...
	<div class="menu">
		<ul id="menu">
			...
			<li id="menu-academico"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span>Washing Point Owner</span> <span class="fa fa-angle-right" style="float: right"></span>
					<div class="clearfix"></div>
				</a>
				<ul id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="addcar-washingpoint-owner.php">Add</a></li>
					<li id="menu-academico-avaliacoes"><a href="managecar-washingpoint-owner.php">Manage</a></li>
				</ul>
			</li>
