...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$capacity = $_POST['washingpointcapacity'];

		$sql = "INSERT INTO tblwashingpoints(washingPointName,washingPointAddress,contactNumber,capacity) VALUES(:wpname,:wpaddress,:wpcnumber,:capacity)";
						...
						<div class="tab-content">
							<div class="tab-pane active" id="horizontal-form">
								<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="focusedinput" class="col-sm-2 control-label">Car Wash Point Capacity</label>
										<div class="col-sm-8">
											<input type="text" class="form-control" name="washingpointcapacity" id="washingpointcapacity" placeholder="Washing Point Capacity Eg: 5" required pattern="[1-9]">
										</div>
									</div>
									<div class="form-group">
