...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['update'])) {
		...
		$sql = "update  tblcarwashbooking set adminRemark=:message,status='Completed' where id=:id";
	...
	if (isset($_POST['Approve'])) {
		...
		$sql = "update  tblcarwashbooking set paymentStatus='payed',paymentMode=:pmade where id=:id";
		$query = $dbh->prepare($sql);
 ...
 where tblcarwashbooking.id='$bid'";
									...
									if ($query->rowCount() > 0) {
										foreach ($results as $result) {				?>
											...
											<?php else : ?>
												...
												<tr>
													<td colspan="4" style="color:blue; font-size:22px; text-align:center; font-weight:bold;">
														<button data-toggle="modal" data-target="#myPayModal" class="btn-primary btn">Collect Payments By Mobile </button>
														<button data-toggle="modal" data-target="#myCashPayModal" class="btn-primary btn">Collect Payments By Cash</button>
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<form method="post">
										...
										<p><textarea name="message" class="form-control" placeholder="Any Comment" required></textarea></p>
										<p><input type="submit" class="btn btn-custom" name="update" value="Completed"></p>
									</form>
								</div>
					...
					<div class="modal fade" id="myPayModal" role="dialog">
						<div class="modal-dialog">
							...
							<div class="modal-content">
								<div class="modal-header">
									<h4 class="modal-title">Collect Payments For #<?php echo $_GET['bookingid']; ?> By Mobile</h4>
								</div>
								<div class="modal-body">
