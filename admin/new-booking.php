					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php $sql = "SELECT *,tblcarwashbooking.id as bid 
									from tblcarwashbooking join tblwashingpoints on tblwashingpoints.id=tblcarwashbooking.carWashPoint 
									  where status='New' and  tblcarwashbooking.carWashPoint='$_SESSION[carwash]' and tblcarwashbooking.paymentStatus='payed'";
