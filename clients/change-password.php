...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "SELECT password FROM tblclients WHERE id=:username and password=:password";
		...
		if ($query->rowCount() > 0) {
			$con = "UPDATE tblclients set password=:newpassword where id=:username";
...
?>
	...
	<head>
		<title>CWMS | Clients Change Password</title>
